...
class ProductsSecurityApplicationTests {
    ...
    @Test
    void test1() throws IOException, WriterException, ParseException {
        String path = "src/main/resources/static/images/image/qrcode/qrcode10001.png";
        String path2 = "/images/image/qrcode/qrcode10001.png";
        String path3 = "target/classes/static" + path2;
        QRCodeGenerator.code("http://localhost:8080/get?id=10001", 350, 350, path);
        QRCodeGenerator.code("http://localhost:8080/get?id=10001", 350, 350, path3);
    }
    ...
    @Test
    void test2() throws IOException, WriterException {
        QRCodeGenerator.code("Hello, World", 350, 350, "C:\\Users\\Administrator\\IdeaProjects\\ProductsSecurity\\src\\main\\resources\\static\\images\\qr.png");
    }
